...
heartBtn.addEventListener(const FORMSPREE_ENDPOINT = "https://formspree.io/f/xnjkdeyb"; //https://formspree.io/f/xnjkdeyb
const DATE_RESPONSES_STORAGE_KEY = "mia_date_responses";
...
endFireworksBtn.addEventListener("click", stopFireworksShow);"click", () => menu.classList.toggle("open"));
